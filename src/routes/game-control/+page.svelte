<script>
	...
	function getQuestionNumber(index) {
		// Find how many items of type 'question' are before this index
...
<style>
	...
	.sidebar { width: 320px; background: white; color: #1e293b; display: flex; flex-direction: column; border-right: 1px solid #e2e8f0; }
	.sidebar-header { padding: 1.5rem; background: #fff; border-bottom: 1px solid #f1f5f9; }
	...
	.nav-item { display: flex; align-items: center; gap: 1rem; padding: 1rem; border: 1px solid transparent; border-radius: 12px; background: #f8fafc; color: #475569; cursor: pointer; text-align: left; transition: all 0.2s; }
	...
	.prep-indicator { color: #f59e0b; font-weight: 800; font-size: 0.8rem; }
	...
	.mega-live-btn { width: 100%; padding: 1.5rem; background: #2563eb; color: white; border: none; border-radius: 12px; font-size: 1.25rem; font-weight: 800; cursor: pointer; display: flex; align-items: center; justify-content: center; gap: 1rem; transition: all 0.2s; }
	.mega-live-btn.prep { background: #f59e0b; box-shadow: 0 4px 14px 0 rgba(245,158,11,0.39); }
	...
	.ctrl-btn { width: 50px; height: 50px; border-radius: 50%; border: none; background: #334155; color: white; cursor: pointer; display: flex; align-items: center; justify-content: center; font-size: 1.2rem; transition: all 0.2s; }
